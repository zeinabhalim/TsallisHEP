...
void xxc23() 
{
    ...
    std::vector<std::string> filenames = {
        "xxe1.txt", "xxe2.txt", "xxe3.txt", "xxe4.txt",
        "xxe5.txt", "xxe6.txt", "xxe7.txt", "xxe8.txt"
    };
    ...
    std::ofstream outfile("Tsallisfit_parametersauau.txt");
    outfile << "Fitting of the transverse momentum spectra of charged particles in Xe-Xe at √s_NN = 5.44 TeV" << std::endl;
    ...
    for (size_t file_index = 0; file_index < filenames.size(); ++file_index) {
        ...
        if (file_index == 0) {
            // 0-5%
            TsallisFitpb->SetParLimits(0, 0.001, 10 ); 
            TsallisFitpb->SetParLimits(1, 1.1, 1.146);
            TsallisFitpb->SetParLimits(2, 0.2, 0.5); 
            TsallisFitpb->SetParLimits(3,0.01,4.0);  
          ...
          TsallisFitpb->SetParLimits(0, 0.001, 10); 
            TsallisFitpb->SetParLimits(1, 1.1, 1.146);
            TsallisFitpb->SetParLimits(2, 0.2, 0.5); 
            TsallisFitpb->SetParLimits(3,0.001, 3.5);  
            ...
            // 20-30%
              TsallisFitpb->SetParLimits(0, 0.01, 10); 
            TsallisFitpb->SetParLimits(1, 1.1, 1.147);
            TsallisFitpb->SetParLimits(2, 0.2, 0.49); 
            TsallisFitpb->SetParLimits(3,0.01, 3.5);  
            TsallisFitpb->FixParameter(4, 0.0);
        } else if (file_index == 4) {
            // 30-40%
           TsallisFitpb->SetParLimits(0, 0.01, 5); 
            ...
            // 50-60%
         TsallisFitpb->SetParLimits(0, 0.001, 5.0); 
            TsallisFitpb->SetParLimits(1, 1.1, 1.147);
    ...
    title->DrawLatex(0.15, 0.96, " Xe Xe --> Charged X , #sqrt{s_{NN}} = 5.44 TeV ");

    
    // Save the canvas
    canvas->SaveAs("Tsallis_fit_xexe.png");
    canvas->Draw("APL");
    ...
    summaryfile << "TSALLIS FIT PARAMETERS - Xe-Xe √s_NN = 5.44 TeV" << std::endl;
    summaryfile << "===============================================================================" << std::endl;
    summaryfile << std::endl;
    ...
    std::ofstream csvfile("Tsallis_fit_parametersxexe.csv");
